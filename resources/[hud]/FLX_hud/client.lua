		...
		if rdy then
			if ShowHUD then
				...
				local armor = GetPedArmour(myPed)                
		     	...
		     	drawTxt3(1.137, 0.523, 1.0,1.0,0.40 , "" .."" ,255, 255, 255, 255) 
				drawTxt3(1.135, 0.415, 1.0,1.0,0.50 , "" ..math.ceil(faimVal) .. "", 255, 255, 255, 255) 

				drawTxt3(1.137, 0.563, 1.0,1.0,0.40 , "" .."" ,255, 255, 255, 255) 
				drawTxt3(1.135, 0.362, 1.0,1.0,0.50 , "" ..math.ceil(soifVal) .. "", 255, 255, 255, 255) 
