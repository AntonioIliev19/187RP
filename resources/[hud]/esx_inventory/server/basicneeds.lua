...
TriggerEvent('es:addGroupCommand', 'heal', 'admin', function(source, args, user)
	...
	if args[1] then
		...
		if target ~= nil then
			...
			if GetPlayerName(target) then
				print('esx_basicneeds: ' .. GetPlayerName(source) .. ' беше излекуван.!')
				TriggerClientEvent('esx_basicneeds:healPlayer', target)
				TriggerClientEvent('chatMessage', target, "HEAL", {223, 66, 244}, "Ти беше излекуван.!")
			else
				TriggerClientEvent('chatMessage', source, "HEAL", {255, 0, 0}, "Грешно ID.!")
			end
		else
			TriggerClientEvent('chatMessage', source, "HEAL", {255, 0, 0}, "Грешно ID.")
		end
	...
	TriggerClientEvent('chatMessage', source, "HEAL", {255, 0, 0}, "Нямаш право да използваш тази команда.")
end, {help = "Възвръща кръв, глад и жажда."})