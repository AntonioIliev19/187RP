...
TriggerEvent('esx:getSharedObject', function(obj) sESX = obj end)
...
ESX.RegisterUsableItem('bread', function(source)
	...
	TriggerClientEvent('esx_status:add', source, 'food', 200000)
...
TriggerEvent('es:addGroupCommand', 'heal', 'admin', function(source, args, user)
	...
	if args[1] then
		...
		if target ~= nil then
			...
			if GetPlayerName(target) then
				...
				TriggerClientEvent('chatMessage', target, "FEED", {223 66, 244}, "You have been healed!")
			else
				TriggerClientEvent('chatMessage', source, "FEED", {255, 0, 0}, "Player not found!")
			end
		else
	...
	TriggerClientEvent('chatMessage', source, "FEED", {255 0 0}, "Insufficient Permissions.")
