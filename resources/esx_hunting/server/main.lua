...
AddEventHandler('esx-qalle-hunting:sell', function()
    ...
    if MeatQuantity > 0 or LeatherQuantity > 0 then
        ...
        TriggerClientEvent('esx:showNotification', xPlayer.source, 'Ти продаде ' .. LeatherQuantity + MeatQuantity .. ' и спечели $' .. LeatherPrice * LeatherQuantity + MeatPrice * MeatQuantity)
    else
        TriggerClientEvent('esx:showNotification', xPlayer.source, 'Нямаш никаква кожа и месо в иневтара си!')
    end
