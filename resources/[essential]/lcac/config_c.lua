...
LXC.DLogger = false -- LOG on DISCORD when someone get detected / kicked / banned (recommended)
...
LXC.BanOnKick = false -- AUTOMATICALLY BAN A DETECTED USER (optional, for lazy people) #can be unstable
...
LXC.DetectExplosions = false -- ONESYNC ONLY!! Detects explosions and cancel them.
