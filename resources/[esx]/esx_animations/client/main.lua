...
Citizen.CreateThread(function()
	while true do
		...
		if IsControlJustReleased(0, Keys['Z']) and GetLastInputMethod(2) and not isDead then
			OpenAnimationsMenu()
		end

		if IsControlJustReleased(0, Keys['ALT']) and GetLastInputMethod(2) and not isDead then
