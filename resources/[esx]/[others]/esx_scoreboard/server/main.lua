...
TriggerEvent('es:addGroupCommand', 'screfresh', 'admin', function(source, args, user)
	...
	TriggerClientEvent('chat:addMessage', source, { args = { '^Система', 'Нямаш разрешение да използваш тази команда.' } })
end, {help = "Презаредете списъка с плейъри!"})
...
TriggerEvent('es:addGroupCommand', 'sctoggle', 'admin', function(source, args, user)
	...
	TriggerClientEvent('chat:addMessage', source, { args = { '^Система', 'Нямаш разрешение да използваш тази команда.' } })
end, {help = "Премахване на колоната ID."})
