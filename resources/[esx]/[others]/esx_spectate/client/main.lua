...
function OpenAdminActionMenu(player)
    ...
    for i=1, #data.accounts, 1 do
      ...
      if data.dob ~= nil then
        dobLabel = 'Дата на раждане : ' .. data.dob
      else
        dobLabel = 'Дата на раждане: неизвестна'
      end

      if data.height ~= nil then
        heightLabel = 'Височина : ' .. data.height
      else
        heightLabel = 'Височина : неизвестна'
      end
      ...
      local elements = {
        {label = 'Име: ' .. data.firstname .. " " .. data.lastname, value = nil},
        {label = 'Пари: '.. data.money, value = nil},
        {label = 'Банка: '.. data.bank, value = nil},
        {label = 'Мръсни пари: '.. blackMoney, value = nil, itemType = 'item_account', amount = blackMoney},
		{label = jobLabel,    value = nil},
        {label = idLabel,     value = nil},
    }
	
    table.insert(elements, {label = '--- Раница ---', value = nil})
    ...
    table.insert(elements, {label = '--- Оръжия ---', value = nil})
    ...
    for i=1, #data.weapons, 1 do
      ...
      if data.licenses ~= nil then
        ...
        table.insert(elements, {label = '--- Лицензи ---', value = nil})
