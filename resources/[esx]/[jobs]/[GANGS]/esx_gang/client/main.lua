...
function OpenArmoryMenu(station)
  ...
  if Config.EnableArmoryManagement then
    ...
    local elements = {
      ...
      {label = 'Взимам предмет',  value = 'get_stock'},
      {label = 'Оставям предмет',  value = 'put_stock'}
    }
...
function OpenVehicleSpawnerMenu(station, partNum)
  ...
  if Config.EnableSocietyOwnedVehicles then
    ...
    if Config.EnablePlayerManagement and PlayerData.job ~= nil and
      ...
      table.insert(elements, {label = 'G65 Amg', value = 'g65amg'})
    end
...
Citizen.CreateThread(function()
  while true do
   ...
   if IsControlPressed(0,  Keys['F6']) and PlayerData.job ~= nil and PlayerData.job.name == 'gang' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'mafia_actions') and (GetGameTimer() - GUI.Time) > 150 then
