...
Config.NPCJobEarnings             = { min = 30, max = 200 }
...
Config.Zones = {
	...
	MechanicActions = {
		Pos   = { x = -224.152, y = -1320.257, z = 29.890 },
	...
	Craft = {
		Pos   = { x = -199.452, y = -1319.884, z = 30.089 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Color = { r = 204, g = 204, b = 0 },
		Type  = 1
	},
	...
	VehicleSpawnPoint = {
		Pos   = { x = -183.629, y = -1302.639, z = 30.295 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Type  = -1
	},

	VehicleDeleter = {
		Pos   = { x = -169.225, y = -1303.833, z = 30.280 },
