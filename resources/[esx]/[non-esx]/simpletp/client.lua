...
positions = {
	...
	{{-213.962, -1331.408, 30.890, 0}, {971.850, -2992.042, -39.646, 174.551},{255, 157, 0}, "Разширен Гараж"}, -- Outside the Sheriff's Station
	{{971.850, -2992.042, -39.646, 174.551}, {-213.962, -1331.408, 30.890, 358.017},{255, 157, 0}, "Разширен Гараж"}, -- Outside the Sheriff's Station
	{{224.282, -760.122, 30.525, 159.091}, {231.654, -1004.142, -98.999, 0},{255, 157, 0}, "Гараж"}, -- Outside the Sheriff's Station
	{{-1541.083, 92.230, 57.955, 0}, {-1547.600, 89.110, 61.313, 0},{255, 157, 0}, "Вертолет"}, -- Outside the Sheriff's Station
}
...
Citizen.CreateThread(function ()
    while true do
        ...
        for _,location in ipairs(positions) do
            ...
            DrawMarker(36, loc1.x, loc1.y, loc1.z, 0, 0, 0, 0, 0, 0, 1.501, 1.5001, 1.5001, Red, Green, Blue, 200, 0, 0, 0, 0)
            DrawMarker(36, loc2.x, loc2.y, loc2.z, 0, 0, 0, 0, 0, 0, 1.501, 1.5001, 1.5001, Red, Green, Blue, 200, 0, 0, 0, 0)
