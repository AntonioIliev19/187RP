local VoiceMode = {
	{ dist = 3, message = "Радиус на говор 3 метра." },
	{ dist = 8, message = "Радиус на говор 8 метра." },
	{ dist = 14, message = "Радиус на говор 14 метра." },
	{ veh = true, dist = 4, func = function(ped) return IsPedInAnyVehicle(ped) end, message = "Радиус на говор само в колата." },
}
