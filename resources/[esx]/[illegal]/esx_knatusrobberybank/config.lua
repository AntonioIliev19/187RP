...
Banks = {
	["fleeca"] = {
		...
		reward = math.random(50000,100000), -- the random range of amount of money you will get for robbery this site
	...
	["blainecounty"] = {
		...
		reward = math.random(15000,100000),
	...
	["PrincipalBank"] = {
		...
		reward = math.random(50000,300000),
