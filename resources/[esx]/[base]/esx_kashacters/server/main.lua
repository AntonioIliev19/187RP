...
local IdentifierTables = {
	...
	{table = "baninfo", column = "identifier"},
	{table = "banlist", column = "identifier"},
	{table = "banlisthistory", column = "identifier"},
	...
	{table = "open_car", column = "identifier"},
...
AddEventHandler('kashactersS:CharacterChosen', function(charid, ischar)
    ...
    if ischar == "true" then
        ...
        spawn = { x = -1037.608, y = -2737.566, z = 20.169 } -- DEFAULT SPAWN POSITION
    end
