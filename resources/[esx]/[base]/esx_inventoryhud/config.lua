...
Config.CloseUiItems = {"tunerchip", "tuning_laptop", "repairkit", "bandage", "medikit", "headbag", "fishingrod", "tunerlaptop", "binoculars", "gps", "joint", "cigarette", "cigar", "fixkit", "rollingpaper", "cocaine", "meth"}
...
Config.Shops = {
    ...
    YouTool = {
        Locations = {
            {x = 27234548.0, y = 34234573.0, z = 123455.68},
        },
        Items = {
            {name = 'drill'},
            {name = 'binocular'},
