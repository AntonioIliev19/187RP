...
ESX.RegisterServerCallback('esx_society:setJob', function(source, cb, identifier, job, grade, type)
  ...
  if isBoss then
      ...
      notifMsg    = "[JOB] | " ..xPlayer.name.. " ["..xPlayer.identifier.. "] бе автоматично изритан за опит да се постави на шефското място."
      ...
      TriggerClientEvent('chatMessage', -1, '^3[Chat]', {255, 0, 0}, "^3" ..xPlayer.name.. "^1беше изритан за опит да се постави на шефското място.")
