...
RegisterNetEvent("esx_society:notify")
AddEventHandler("esx_society:notify", function(icon, type, sender, title, text)
    Citizen.CreateThread(function()
		Wait(1)
        ...
        elseif data.current.value == 'wash_money' then
            ...
            ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'wash_money_amount_' .. society,
            {
               title = _U('wash_money_amount')
                ...
                if amount == nil then
                    -- ESX.ShowNotification(_U('invalid_amount'))
					TriggerEvent("esx_society:notify", "CHAR_LESTER_DEATHWISH", 1, _U('Notification'), false, _U('invalid_amount'))
						ESX.UI.Menu.CloseAll()
                else
                    menu.close()
                    -- TriggerServerEvent('esx_society:washMoney', society, amount)
					TriggerServerEvent('esx_society:washMoney', amount)
                end
