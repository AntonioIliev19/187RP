      ...
      ESX.UI.Menu.Open(
        'default', GetCurrentResourceName(), 'shop_confirm',
        {
          ...
          elements = {
            ...
            {label = ('Имате (30 секунди тестов период)'), value = 'test'},
        ...
        function (data2, menu2)
          ...
          if data2.current.value == 'test' then
            ...
            ESX.Game.SpawnVehicle(vehicleData.model, Config.Zones.ShopOutside.Pos, Config.Zones.ShopOutside.Heading, function(vehicle)
                ...
                TriggerEvent("pNotify:SendNotification", {text = "Теста за МПС е 30 секунди.", type = "error", timeout = 40000, layout = "centerLeft"})
                Citizen.Wait(40000)
                ESX.Game.DeleteVehicle(vehicle)
                ESX.Game.Teleport(PlayerPedId(), {x = 228.12, y = -991.59, z = -99.97 })
                TriggerEvent("pNotify:SendNotification", {text = "Теста свърши.", type = "error", timeout = 2400, layout = "centerLeft"})
            end)
