...
Config.UseVehicleNamesLua = false -- true = Use a vehicle_names.lua for Addon Vehicles.

Config.ShowGarageSpacer1 = false -- true = Shows spacer1 in Garage Menu.
...
Config.ShowPoundSpacer3 = false -- true = Shows spacer3 in Pound Menu. Note: Don't use if "Config.ShowPoundSpacer2 = true".
...
Config.CarGarages = {
	Garage_CentralLS = {
		GaragePoint = { x = 234.969, y = -976.247, z = -98.999 },
		SpawnPoint = { x = 227.852, y = -987.163, z = -99.999, h = 178.823 },
		DeletePoint = { x = 226.501, y = -987.065, z = -98.999 }
	},
	Garage_Sandy = {
	...
	Garage_Prison = {
		GaragePoint = { x = 1851.160, y = 2585.851, z = 45.67 },
		SpawnPoint = { x = 1855.11, y = 2592.72, z = 44.67, h = 274.8 },
		DeletePoint = { x = 1855.21, y = 2615.3, z = 34.67 } -- z = 44.67
	},

	Garage_RaceTrack = {
		GaragePoint = { x = -810.057, y = 188.077, z = 72.478 },
		SpawnPoint = { x = -824.412, y = 180.971, z = 71.115 },
		DeletePoint = { x = -824.412, y = 180.971, z = 71.115 }
	}
}
