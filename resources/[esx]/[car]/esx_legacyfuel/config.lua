...
Config.Strings = {
	ExitVehicle = "Излезте от превозното средство, за да заредите колата",
    EToRefuel = "Натиснете ~g~E~w~ за да заредите МПС-то",
    JerryCanEmpty = "Тубата с бензин е празна",
    FullTank = "Резервоарът е пълен",
    PurchaseJerryCan = "Натиснете ~g~E~w~ за да си купите туба с бензин за ~g~$" .. Config.JerryCanCost,
    CancelFuelingPump = "Натиснете ~g~E~w~ да спрете зареждането с гориво",
    CancelFuelingJerryCan = "Натиснете ~g~E~w~ да спрете зареждането на тубата",
    NotEnoughCash = "Нямате достатъчно пари",
    RefillJerryCan = "Натиснете ~g~E~w~ за да презаредите тубата с бензин ",
    NotEnoughCashJerryCan = "Нямате достатъчно пари за да заредите тубата с бензин",
    JerryCanFull = "Тубата с бензин е пълна",
    TotalCost = "",
}
