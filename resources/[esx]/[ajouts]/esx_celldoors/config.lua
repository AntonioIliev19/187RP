...
Config.DoorList = {
	...
	
	{
		objName = 'v_ilev_fa_frontdoor',
			objCoords  = {x = -13.977, y = -1441.155, z = 31.102},
			textCoords = {x = -13.977, y = -1441.155, z = 32.102},
			authorizedJobs = { 'mangal' },
			locked = true
	},
	...
	
	{
		...
		objCoords  = {x = 1956.906, y = 5174.404, z = 47.983},
		textCoords = {x = 1956.906, y = 5174.404, z = 48.483},
		authorizedJobs = { 'gang' },
		locked = true,
		distance = 12,
		size = 1
	...
	
	{
		...
		objCoords  = {x = -1501.130, y = 103.623, z = 55.673},
		textCoords = {x = -1501.130, y = 103.623, z = 56.673},
	...
	{
		objName = 'v_ilev_mm_door',
		objCoords  = {x = -1522.537, y = 143.149, z = 55.664},
		textCoords = {x = -1522.537, y = 143.149, z = 56.664},
		authorizedJobs = { 'mafia' },
		locked = true,
		distance = 4,
		size = 2
	...
	
	{
		...
		objCoords  = {x = -1536.692, y = 131.088, z = 57.374},
		textCoords = {x = -1536.692, y = 131.088, z = 58.374},
		authorizedJobs = { 'mafia' },
		locked = true,
		distance = 4,
		size = 2
	...
	
	{
		...
		objCoords  = {x = 8.359, y = 539.627, z = 176.027},
		textCoords = {x = 8.359, y = 539.627, z = 176.027},
	...
	
	{
		...
		objCoords  = {x = 981.560, y = -102.611, z = 74.845},
		textCoords = {x = 981.560, y = -102.611, z = 74.845},
...

	{
		...
		objCoords  = {x = -815.825, y = 186.010, z = 71.473},
		textCoords = {x = -815.825, y = 186.010, z = 72.473},
		authorizedJobs = { 'state' },
		locked = true,
		distance = 8,
		size = 2
...

	{
		...
		objCoords  = {x = -816.976, y = 177.992, z = 71.227},
		textCoords = {x = -816.976, y = 177.992, z = 72.227},
		authorizedJobs = { 'state' },
		locked = true,
		distance = 3,
		size = 2
...

	{
		...
		objCoords  = {x = -795.210, y = 177.128, z = 71.835},
		textCoords = {x = -795.210, y = 177.128, z = 72.835},
		authorizedJobs = { 'state' },
		locked = true,
		distance = 3,
		size = 2
	...
	{
		objName = 'prop_bh1_48_backdoor_l',
		objCoords  = {x = -793.186, y = 181.819, z = 71.835},
		textCoords = {x = -793.186, y = 181.819, z = 72.835},
		authorizedJobs = { 'state' },
		locked = true,
		distance = 3,
		size = 2
