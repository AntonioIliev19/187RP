...
function OpenShopMenu()
  ...
  table.insert(elements, {
	label = ('<span style="color:lightgreen;">Магазин за дрехи</span>'),(_U('shop_clothes')), 
	value = 'shop_clothes'
})
  ...
  table.insert(elements, {
	label = ('<span style="color:red;">Свалете си дрехите</span>'),(_U('suppr_cloth')), 
	value = 'suppr_cloth'
})
	...
	TriggerEvent('esx_skin:openRestrictedMenu', function(data, menu)
		...
		ESX.UI.Menu.Open(
			'default', GetCurrentResourceName(), 'shop_confirm',
			{
				...
				align = 'right',
				elements = {
					{label = ('<span style="color:lightgreen;">Платете</span>'), value = 'yes'},
					{label = ('<span style="color:red;">Откажете</span>'), value = 'no'},
				}
			},
			function(data, menu)
				...
				if data.current.value == 'yes' then
					...
					ESX.TriggerServerCallback('esx_eden_clotheshop:checkMoney', function(hasEnoughMoney)
						...
						if hasEnoughMoney then
								...
								if foundStore then
									...
									ESX.UI.Menu.Open(
										'default', GetCurrentResourceName(), 'save_dressing',
										{
											...
											align = 'right',
											elements = {
												{label = ('<span style="color:lightgreen;">Запазете в гардероба</span>'), value = 'yes'},
												{label = ('<span style="color:red;">Откажете</span>'),  value = 'no'},
											}
										},
											...
											if data2.current.value == 'yes' then
												...
												ESX.UI.Menu.Open(
													...
													function(data3, menu3)
														...
														ESX.ShowAdvancedColoredNotification(('Магазин'), ('за дрехи'), _U('saved_outfit'), 'CHAR_HUMANDEFAULT', 1, 2)
							...
							ESX.ShowAdvancedColoredNotification(('Магазин'), ('за дрехи'), _U('not_enough_money'), 'CHAR_BANK_MAZE', 1, 2)
            ...
            function(data, menu)
              ...
              TriggerEvent('skinchanger:getSkin', function(skin)
                ...
                ESX.TriggerServerCallback('esx_eden_clotheshop:getPlayerOutfit', function(clothes)
				  ...
				  ESX.ShowAdvancedColoredNotification(('Магазин'), ('за дрехи'), _U('loaded_outfit'), 'CHAR_HUMANDEFAULT', 1, 2)
				  HasLoadCloth = true
	  ...
	  if data.current.value == 'suppr_cloth' then
		ESX.TriggerServerCallback('esx_eden_clotheshop:getPlayerDressing', function(dressing)
            ...
            {
			  css	   = 'skin',
              title    = ('<span style="color:red;">Свалете си дрехите</span>'), 
              align    = 'left',
              elements = elements,
            },
            function(data, menu)
			menu.close()
				...
				ESX.ShowAdvancedColoredNotification(('Магазин'), ('за дрехи'), _U('supprimed_cloth'), 'CHAR_HUMANDEFAULT', 1, 2)
