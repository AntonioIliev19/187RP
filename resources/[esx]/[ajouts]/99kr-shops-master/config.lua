Config = {
    ...
    Items = {
        ["drinks"] = {
            ...
            {label = "Сода", item = "soda", price = 3},
            {label = "Бира", item = "beer", price = 5},
            {label = "Студен чай", item = "icetea", price = 4},
            {label = "Бяло Мартини", item = "martini", price = 8},
            {label = "Др. Пепър", item = "drpepper", price = 4},
            {label = "Вода", item = "water", price = 2},
            {label = "Редбул", item = "redgull", price = 5},
       },
        ["snacks"] = {
            {label = "Фъстъци", item = "bolchips", price = 12},
        },
        ["readymeal"] = {
            {label = "Бургер", item = "hamburger", price = 15},
            {label = "Сандвич с кюфтета", item = "hamburgerplate", price = 20},
            {label = "Хляб", item = "bread", price = 4},
            {label = "Кебапче", item = "beef", price = 10},
            {label = "Торта", item = "cupcake", price = 12},
        },
        ["diverse"] = {
            {label = "Цигара", item = "cigarett", price = 1},
            {label = "Телефон", item = "phone", price = 500},
            {label = "СИМ Карта", item = "sim", price = 250},
			{label = "GPS", item = "gps", price = 250},
            {label = "Запалка", item = "lighter", price = 5},
			{label = "Чук и секачки", item = "hammerwirecutter", price = 5500},
            {label = "Интерфейс на алармата", item = "alarminterface", price = 1050},
            {label = "Роза", item = "rose", price = 3},
            {label = "Кошница за пикник", item = "picnic", price = 15},
            {label = "Чадър", item = "umbrella", price = 10},
            {label = "Крик", item = "carjack", price = 700},
            {label = "Количка", item = "rccar", price = 1300},
			{label = "Бинокъл", item = "jumelles", price = 300},
        },
    },
}