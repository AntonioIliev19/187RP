Locales['en'] = {
  ['by_default'] = 'default',
  ['installed'] = 'Монтирано',
  ['already_own'] = 'Вече притежавате: ~b~%s~s~',
  ['not_enough_money'] = 'Не можете да позволите този модел!',
  ['purchased'] = 'Вие закупихте този модел!',
  ['press_custom'] = 'Натисни ~INPUT_PICKUP~ за да ~y~тунинговаш~s~ твоят автомобил.',
  ['level'] = 'level %s',
  ['neon'] = 'neon',
