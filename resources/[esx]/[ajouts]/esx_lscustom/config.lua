...
Config.Zones = {
	...
	ls5 = {
		Pos   = { x = -211.644, y = -1323.957, z = 30.339},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
	...
	ls6 = {
		Pos   = { x = 977.793, y = -3002.238, z = -39.603},
...
Config.Menus = {
	...
	modEngine = {
		...
		parent = 'upgrades',
		modType = 11,
		price = {0.95, 3.56, 5.12, 6.53}
	},
	modBrakes = {
		label = _U('brakes'),
		parent = 'upgrades',
		modType = 12,
		price = {1.65, 3.3, 6.6, 9.95}
	},
	modTransmission = {
		label = _U('transmission'),
		parent = 'upgrades',
		modType = 13,
		price = {5.95, 10.93, 20.51}
	},
	modSuspension = {
		label = _U('suspension'),
		parent = 'upgrades',
		modType = 15,
		price = {1.72, 3.44, 5.88, 7.77, 10.2}
	},
	modArmor = {
		label = _U('armor'),
		parent = 'upgrades',
		modType = 16,
		price = {2.77, 5.28, 7.00, 8.00, 9.00, 10.00}
	},
	modTurbo = {
		label = _U('turbo'),
		parent = 'upgrades',
